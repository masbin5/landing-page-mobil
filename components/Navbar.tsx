      ...
      <div className="mx-auto max-w-7xl rounded-2xl border border-white/70 bg-white/90 shadow-[0_10px_40px_rgba(16,52,91,0.08)] backdrop-blur-xl">
        <div className="flex items-center justify-between px-5 py-3">
          <a href="/" className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[#0d3c78] text-white">
          ...
          <nav className="hidden items-center gap-8 text-sm font-semibold text-slate-600 lg:flex">
            <a href="/" className="transition hover:text-[#0d3c78]">
              Beranda
            </a>
            <a href="/#lineup" className="transition hover:text-[#0d3c78]">
              Model Kendaraan
            </a>
            <a href="/#promo" className="transition hover:text-[#0d3c78]">
              Promo
            </a>
            <a href="/testimoni" className="transition hover:text-[#0d3c78]">
              Testimoni
            </a>
          </nav>
        ...
        {open && (
          <div className="border-t border-slate-100 px-5 pb-5 pt-4 sm:hidden">
            <div className="flex flex-col gap-4 text-sm font-bold text-slate-700">
              <a href="/">Beranda</a>
              <a href="/#lineup">Model Kendaraan</a>
